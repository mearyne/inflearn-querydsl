...
class MemberJpaRepositoryTest {
    ...
    public void searchTest() {
        ...
        List<MemberTeamDto> result1 = memberJpaRepository.searchByBuilder(memberSearchCondition1);
        List<MemberTeamDto> result2 = memberJpaRepository.searchByBuilder(memberSearchCondition2);
        List<MemberTeamDto> result3 = memberJpaRepository.searchByBuilder(memberSearchCondition3);
        List<MemberTeamDto> result4 = memberJpaRepository.searchByBuilder(memberSearchCondition4);
